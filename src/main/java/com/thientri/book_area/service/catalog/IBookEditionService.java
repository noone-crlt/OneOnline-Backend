...
public interface IBookEditionService {
    ...
    void createEdition(EditionCreateRequest request, 
                       MultipartFile coverFile, 
                       MultipartFile contentFile, 
                       List<MultipartFile> audioFiles);
    
    // Cập nhật giá và tồn kho
    // void updatePriceAndStock(String skuCode, BigDecimal newPrice, Integer addedStock);

    // Cập nhật thông tin và thay thế file của phiên bản
    void updateEdition(Long editionId, 
                       EditionUpdateRequest request,
                       MultipartFile newCoverFile, 
